...
const MIGRATION_STEPS: MigrationStep[] = [
  ...
  DEPLOY_V3_CORE_FACTORY,  //UniswapV3Factory
  ADD_1BP_FEE_TIER,
  DEPLOY_MULTICALL2,    //UniswapInterfaceMulticall
  DEPLOY_PROXY_ADMIN,
  DEPLOY_TICK_LENS,
  DEPLOY_NFT_DESCRIPTOR_LIBRARY_V1_3_0,    //NFTDescriptor
  DEPLOY_NFT_POSITION_DESCRIPTOR_V1_3_0,    //NonfungibleTokenPositionDescriptor
  DEPLOY_TRANSPARENT_PROXY_DESCRIPTOR,
  DEPLOY_NONFUNGIBLE_POSITION_MANAGER,  //NonfungiblePositionManager
  DEPLOY_V3_MIGRATOR,   //V3Migrator
  TRANSFER_V3_CORE_FACTORY_OWNER,
  DEPLOY_V3_STAKER,
  DEPLOY_QUOTER,  //Quoter
  DEPLOY_V3_SWAP_ROUTER_02,  //SwapRouter02
